...
def main():
    ...
    all_algorithems = [
        ...
        (lambda: FixLayerTwoNetwork(False, LR_FIX, R, use_batch=True, use_crossentropy=True, xavier_init=False), "Convex, Standard init", 'b', "o", False),
        (lambda: FixLayerTwoNetwork(False, LR_FIX, R, sigma=SIGMA_LARGE, use_batch=True, use_crossentropy=True, xavier_init=False), "Convex, Large init", 'g', "s", False),
