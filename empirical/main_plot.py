...
def main():
    ...
    for round_num in range(NUM_OF_RUNNING):
        ...
        result_object.cluster_graph(network_first, "readonce_{0} - ".format(round_num))
        result_object.save_result_to_pickle("W_readonce_{0}.pkl".format(round_num), network_first.W)
        result_object.save_result_to_pickle("result_readonce_{0}.pkl".format(round_num), (train_result, algorithem_result))
